...
def resnet50(pretrained=False):
	...
	if pretrained:
		# pretrained backbone on ImageSet
		state_dict = load_state_dict_from_url("https://download.pytorch.org/models/resnet50-19c8e357.pth",
											  model_dir="./model_data")

		# pretrained backbone of Mask RCNN
		# mask_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
		# mask_path = os.path.join(mask_path, 'model_data/mask.pth')
